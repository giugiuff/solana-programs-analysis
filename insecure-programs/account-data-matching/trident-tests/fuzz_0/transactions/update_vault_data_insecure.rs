...
pub struct UpdateVaultDataInsecureTransaction {
    pub instruction: UpdateVaultDataInsecureInstruction,
}
...
impl TransactionHooks for UpdateVaultDataInsecureTransaction {
    ...
    fn transaction_invariant_check(&self) -> Result<(), FuzzingError> {
        ...
        // 4) invariante: solo l'owner registrato nel vault può aggiornare
