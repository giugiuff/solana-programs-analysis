...
#[discriminator([85u8, 159u8, 154u8, 12u8, 109u8, 17u8, 93u8, 184u8])]
pub struct InsecureLogBalanceV2Instruction {
    pub accounts: InsecureLogBalanceV2InstructionAccounts,
    pub data: InsecureLogBalanceV2InstructionData,
}

/// Instruction Accounts
#[derive(Debug, Clone, TridentAccounts, Default)]
#[instruction_data(InsecureLogBalanceV2InstructionData)]
#[storage(FuzzAccounts)]
pub struct InsecureLogBalanceV2InstructionAccounts {
    #[account(
        storage::name = mint,
...
pub struct InsecureLogBalanceV2InstructionData {}
...
// Versione V2 del hook: riproduce lo stesso scenario manipolando proprietà di account token e owner.
impl InstructionHooks for InsecureLogBalanceV2Instruction {
    type IxAccounts = FuzzAccounts;

    fn set_accounts(&mut self, trident: &mut Trident, fuzz_accounts: &mut Self::IxAccounts) {
        // Inizializza un mint SPL casuale collegato allo slot specificato dallo storage.
        ...
        // Genera l'account token associando il saldo e l'eventuale proprietario fraudolento.
