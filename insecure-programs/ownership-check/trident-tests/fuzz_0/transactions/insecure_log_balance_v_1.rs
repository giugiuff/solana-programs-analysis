...
pub struct InsecureLogBalanceV1Transaction {
    pub instruction: InsecureLogBalanceV1Instruction,
}
...
impl TransactionHooks for InsecureLogBalanceV1Transaction {
    type IxAccounts = FuzzAccounts;

    fn transaction_invariant_check(&self) -> Result<(), FuzzingError> {
        // L'handler dichiara questo owner che useremo come confronto.
