// Builds the secure_log_balance_v_1 transaction for the Ownership Check fuzz run, pairing it with the prepared instruction accounts and data.
...
pub struct SecureLogBalanceV1Transaction {
    pub instruction: SecureLogBalanceV1Instruction,
}
...
impl TransactionHooks for SecureLogBalanceV1Transaction {
    ...
    fn transaction_error_handler(&self, err: TransactionError) {
        ...
        panic!("secure_log_balance_v1 failed unexpectedly: {err:?}");
    }
}
