// Builds the initialize_metadata transaction for the Revival Attack fuzz run, pairing it with the prepared instruction accounts and data.
...
pub struct InitializeMetadataTransaction {
    pub instruction: InitializeMetadataInstruction,
}
...
impl TransactionHooks for InitializeMetadataTransaction {
