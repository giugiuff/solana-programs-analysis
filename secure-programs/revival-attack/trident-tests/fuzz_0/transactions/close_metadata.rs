// Builds the close_metadata transaction for the Revival Attack fuzz run, pairing it with the prepared instruction accounts and data.
...
pub struct CloseMetadataTransaction {
    pub instruction: CloseMetadataInstruction,
}
...
impl TransactionHooks for CloseMetadataTransaction {
