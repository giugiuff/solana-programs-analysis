// Builds the update transaction for the Account Reloading fuzz run, pairing it with the prepared instruction accounts and data.
...
impl TransactionHooks for UpdateTransaction {
