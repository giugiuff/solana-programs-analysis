// Defines lazily-created accounts so the Account Reloading fuzzing scenario can reuse deterministic fixtures between instructions.
...
pub struct FuzzAccounts {
    ...
    pub update_account: AccountsStorage,
}
