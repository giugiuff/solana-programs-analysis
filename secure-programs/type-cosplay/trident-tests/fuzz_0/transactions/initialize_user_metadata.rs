// Builds the initialize_user_metadata transaction for the Type Cosplay fuzz run, pairing it with the prepared instruction accounts and data.
...
pub struct InitializeUserMetadataTransaction {
    pub instruction: InitializeUserMetadataInstruction,
}
...
impl TransactionHooks for InitializeUserMetadataTransaction {
