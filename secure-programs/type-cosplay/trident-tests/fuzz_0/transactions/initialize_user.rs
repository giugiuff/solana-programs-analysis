// Builds the initialize_user transaction for the Type Cosplay fuzz run, pairing it with the prepared instruction accounts and data.
...
pub struct InitializeUserTransaction {
    pub instruction: InitializeUserInstruction,
}
...
impl TransactionHooks for InitializeUserTransaction {
