// Builds the secure_verify_pin transaction for the Arbitrary CPI fuzz run, pairing it with the prepared instruction accounts and data.
...
pub struct SecureVerifyPinTransaction {
    pub instruction: SecureVerifyPinInstruction,
}
...
impl TransactionHooks for SecureVerifyPinTransaction {
