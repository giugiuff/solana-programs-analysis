// Builds the initialize_secret transaction for the Arbitrary CPI fuzz run, pairing it with the prepared instruction accounts and data.
...
pub struct InitializeSecretTransaction {
    pub instruction: InitializeSecretInstruction,
}
...
impl TransactionHooks for InitializeSecretTransaction {
