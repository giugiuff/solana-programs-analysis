// Builds the initialize_fee_vault transaction for the Duplicate Mutable Accounts fuzz run, pairing it with the prepared instruction accounts and data.
...
pub struct InitializeFeeVaultTransaction {
    pub instruction: InitializeFeeVaultInstruction,
}
...
impl TransactionHooks for InitializeFeeVaultTransaction {
