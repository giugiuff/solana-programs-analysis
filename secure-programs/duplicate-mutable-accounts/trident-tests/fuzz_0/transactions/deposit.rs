// Builds the deposit transaction for the Duplicate Mutable Accounts fuzz run, pairing it with the prepared instruction accounts and data.
...
impl TransactionHooks for DepositTransaction {
